...
| Release snapshot | The clean public snapshot was released as `v1.0.0`; the current public maintenance release targets `v1.0.2`. Earlier private workspace history is intentionally not copied into the public repository. |
