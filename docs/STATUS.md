...
_Release line: public v1.0.2 maintenance release. Last updated: 2026-08-23._
...
- **No continuous diagram-to-text editing** — authoring remains two independent paths. Diagram mode now has an explicit, reviewable **Import to Text** action; it does not continuously synchronize edits.
